Public Class LogNormal
    ...
    Public Overrides Function getDistributedVariable(probability As Double) As Double
        Dim z As New Normal()
        Return Math.Exp(_mean + ((_StDev) * (z.getDistributedVariable(probability))))
    End Function
    Public Overrides Function GetCDF(value As Double) As Double
        Dim z As New Normal(_mean, _StDev)
        Return z.GetCDF(Math.Log(value))
    End Function
    Public Overrides Function GetPDF(Value As Double) As Double
        Dim z As New Normal(_mean, _StDev)
        Return z.GetPDF(Math.Log(Value))
    End Function
    ...
    Public Overloads Shared Operator =(left As LogNormal, right As LogNormal) As Boolean
